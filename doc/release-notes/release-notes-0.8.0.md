Kore-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kore/files/Kore/kore-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kore
...
New/changed settings (command-line or kore.conf file)
--------------------------------------------------------
