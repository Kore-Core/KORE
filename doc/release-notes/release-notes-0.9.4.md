Kore Core version 0.9.4 is now available from:

  https://kore.org/bin/0.9.4/
...
this update is incompatible with the Kore system and could lead to consensus
forks.

Kore Core released binaries from https://kore.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kore/+archive/ubuntu/kore
- A third-party or self-compiled Kore Core

upgrade to Kore Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
