...
/** Koreunit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KoreUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KoreUnits(QObject *parent);

    /** Koreunits.
      @note Source: https://en.kore.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KORE,
...
typedef KoreUnits::Unit KoreUnit;
