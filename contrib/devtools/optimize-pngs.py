...
For Ubuntu 16.04
sudo apt-get install python-imaging pngcrush
...
pngcrush = 'pngcrush'
git = 'git'
folders = ["share/qt/img", "doc", "doc/img", "doc/gitian-building", "src/qt/res/movies", "src/qt/res/icons", "share/pixmaps" , "src/qt/res/images"]
