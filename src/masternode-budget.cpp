...
// {
//     return Params().GetMasternodeBudgetPaymentCycle();
// }
...
//     if (conf >= Params().GetBudgetFeeConfirmations()) {
//         return true;
//     } else {
//         strError = strprintf("Collateral requires at least %d confirmations - %d confirmations", Params().GetBudgetFeeConfirmations(), conf);
...
//     int finalizationWindow = Params().GetMasternodeFinalizationWindow();
...
//             return false;
//         }
//         if (vote.nTime - mapVotes[hash].nTime < Params().GetBudgetVoteUpdate()) {
//             strError = strprintf("time between votes is too soon - %s - %lli sec < %lli sec\n", vote.GetHash().ToString(), vote.nTime - mapVotes[hash].nTime, Params().GetBudgetVoteUpdate());
//             LogPrint("mnbudget", "CBudgetProposal::AddOrUpdateVote - %s\n", strError);
//             return false;
//         }
...
//     if (vote.nTime > GetTime() + Params().GetBudgetVoteUpdate()) {
//         strError = strprintf("new vote is too far ahead of current time - %s - nTime %lli - Max Time %lli\n", vote.GetHash().ToString(), vote.nTime, GetTime() + Params().GetBudgetVoteUpdate());
//         LogPrint("mnbudget", "CBudgetProposal::AddOrUpdateVote - %s\n", strError);
//         return false;
//     }
