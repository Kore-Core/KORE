...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CKoreAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CKoreAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CKoreAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CKoreAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CKoreAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CKoreAddress(arr[0].get_str()).Get() == demoAddress.Get());
