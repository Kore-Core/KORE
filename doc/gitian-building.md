...
Clone the git repositories for kore and gitian and then checkout the kore version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/kore-crypto/kore.git
cd kore
...
Follow the instructions in [doc/release-process.md](release-process.md) in the kore repository
...
To build KORE (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the kore repository.
...
```bash
    ...
    From https://github.com/kore-crypto/kore
...
For example:
```bash
URL=https://github.com/crowning-/kore.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/kore-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/kore-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/kore-build.assert
```
...
[kore/gitian.sigs](https://github.com/kore-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
