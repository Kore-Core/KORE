...
/**
  KoreGUI main class. This class represents the main window of the KoreUI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KoreGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KoreGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KoreGUI();
