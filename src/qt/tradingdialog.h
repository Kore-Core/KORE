...
private Q_SLOTS:
    ...
    void on_BuyKORE_clicked();
    void on_SellKOREBTN_clicked();
    ...
    QString BuyKORE(QString OrderType, double Quantity, double Rate);
    QString SellKORE(QString OrderType, double Quantity, double Rate);
