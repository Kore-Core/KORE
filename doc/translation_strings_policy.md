...
This document provides guidelines for internationalization of the Kore Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kore_en.ts` remains unchanged.
