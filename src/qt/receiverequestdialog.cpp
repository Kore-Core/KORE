...
#include "config/kore-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKoreURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KoreUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKoreURI(info));
}
