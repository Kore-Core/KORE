Kore version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kore/files/Kore/kore-0.5.4/
...
http://gitorious.org/kore/kored-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kore-Qt notifications under Growl 1.3.
Increase required age of Kore-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKore properly when installing Kore-Qt over it. (Windows)
